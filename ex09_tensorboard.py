...
def attach_tensorboard_summaries(model):
    tf.scalar_summary('learning_rate', model.learning_rate)
    tf.scalar_summary('model_loss', model.model_loss)
    tf.scalar_summary('optimizer_loss',model.optimizer_loss)
    tf.histogram_summary('flattened_covnet_output', model.conv_outputs)
